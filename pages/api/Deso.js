/* This file has custom apis that we will use 
in the site. In next js all data is fetched in 
the server side */


//Import Deso from a custom npm package.
import Deso from "../../node_modules/optimized-deso";
